...
export const sorts = [
	{
		...
		src: shadejka,
		alt: 'шадейка',
		label: 'отличная лежкость',
		item: 'Шадейка',
		text1: 'Средне-ранний (вегетационный период 105 дней) сорт, отлично хранится до 11 месяцев. Выведен в Пермском Крае. Морозоустойчивый, неприхотлив в уходе, растет на любых почвах. Требует частого полива.',
		...
		item: 'Осенний',
		label: 'осенний',
		text1: 'Один из самых ранних сортов чеснока (вегетационный период 90 дней). Выведен в Западной Сибири. Морозостойкий, нетребователен в уходе.',
